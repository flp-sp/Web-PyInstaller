...
def convert():
    ...
    cliente.containers.run("fydeinc/pyinstaller", command="main.py", volumes={'/home/flp-sp/Projects/webpyinstaller/app/src' : {'bind' : '/src', 'mode' : 'rw'}}, environment=[f"PLATFORMS={single_env}"])
